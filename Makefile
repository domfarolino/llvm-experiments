CXX=g++
PROGRAMS=sample add_arrays arrays_by_reference arrays_by_value string_array_by_reference negate bitwise putX boolTo globalVariable produceBool referenceVar stringArg getX logical_operators logical_operators_single_arrays logical_operators_arrays integer_array_to_float subtract_arrays add_array_scalar subtract_array_scalar
