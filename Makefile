CXX=g++
PROGRAMS=sample add_arrays arrays_by_reference arrays_by_value string_array_by_reference negate bitwise putX boolTo globalVariable produceBool referenceVar stringArg getX logical_operators logical_operators_single_arrays logical_operators_arrays integer_array_to_float subtract_arrays add_array_scalar subtract_array_scalar multiply_arrays divide_arrays divide_array_scalar
...
integer_array_to_float: tests/integer_array_to_float.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)

subtract_arrays: tests/subtract_arrays.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)

add_array_scalar: tests/add_array_scalar.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)

subtract_array_scalar: tests/subtract_array_scalar.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)
...
divide_arrays: tests/divide_arrays.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)

divide_array_scalar: tests/divide_array_scalar.cpp
	$(CXX) $^ -o tests/$@ $(CFLAGS)
