...
@5 = private unnamed_addr constant [20 x i8] c"bitwise and result:\00"
@6 = private unnamed_addr constant [19 x i8] c"bitwise or result:\00"
...
entry:
  ...
  store i32 %0, i32* %bitwiseResult
  call void @putString(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @5, i32 0, i32 0))
  %bitwiseResult5 = load i32, i32* %bitwiseResult
  call void @putInteger(i32 %bitwiseResult5)
  ret void
}
...
entry:
  ...
  store i32 %0, i32* %bitwiseResult
  call void @putString(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @6, i32 0, i32 0))
  %bitwiseResult5 = load i32, i32* %bitwiseResult
  call void @putInteger(i32 %bitwiseResult5)
  ret void
}
