...
@14 = private unnamed_addr constant [51 x i8] c"Printing final_float_array (aka float + integer[])\00"
...
loop23:                                           ; preds = %condeval22
  ...
  %14 = fadd double %integer-to-float21, %13
...
loop56:                                           ; preds = %condeval55
  ...
  %50 = fadd double 2.000000e+00, %49
...
loop67:                                           ; preds = %condeval66
  ...
  %62 = fadd double 5.000000e+00, %61
...
loop104:                                          ; preds = %condeval103
  ...
  %89 = fadd double %88, 4.000000e+00
