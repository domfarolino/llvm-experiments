...
@10 = private unnamed_addr constant [26 x i8] c"Assigningn array elements\00"
...
entry:
  ...
  store i32 0, i32* %i
  call void @putString(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @10, i32 0, i32 0))
  br label %condeval
...
loop23:                                           ; preds = %condeval22
  ...
  %14 = fsub double %integer-to-float21, %13
...
loop67:                                           ; preds = %condeval66
  ...
  %62 = fsub double %61, 5.000000e+00
...
loop104:                                          ; preds = %condeval103
  ...
  %89 = fsub double %88, 4.000000e+00
