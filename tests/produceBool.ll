...
@10 = private unnamed_addr constant [13 x i8] c"it was true!\00"
@11 = private unnamed_addr constant [14 x i8] c"it was false!\00"
...
then:                                             ; preds = %entry
  call void @putString(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @10, i32 0, i32 0))
  br label %ifmerge
