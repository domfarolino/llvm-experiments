...
postloop11:                                       ; preds = %condeval5
  %my_array12 = load [10 x i32], [10 x i32]* %my_array
  call void @takes_array([10 x i32] %my_array12)
  store i32 0, i32* %i
  call void @putString(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @15, i32 0, i32 0))
  br label %condeval13

condeval13:                                       ; preds = %loop15, %postloop11
  %i14 = load i32, i32* %i
  %5 = icmp slt i32 %i14, 10
  br i1 %5, label %loop15, label %postloop19

loop15:                                           ; preds = %condeval13
  %i16 = load i32, i32* %i
  %array-index17 = getelementptr [10 x i32], [10 x i32]* %my_array, i64 0, i32 %i16
  %6 = load i32, i32* %array-index17
...
loop:                                             ; preds = %condeval
  %i3 = load i32, i32* %i
  %array-index = getelementptr [10 x i32], [10 x i32]* %input_array1, i64 0, i32 %i3
...
condeval5:                                        ; preds = %loop7, %postloop
  %i6 = load i32, i32* %i
  %3 = icmp slt i32 %i6, 10
  br i1 %3, label %loop7, label %postloop11

loop7:                                            ; preds = %condeval5
  call void @putString(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @11, i32 0, i32 0))
  %i8 = load i32, i32* %i
  %array-index9 = getelementptr [10 x i32], [10 x i32]* %input_array1, i64 0, i32 %i8
  store i32 66, i32* %array-index9
  %i10 = load i32, i32* %i
  %4 = add i32 %i10, 1
  store i32 %4, i32* %i
  br label %condeval5
...
loop14:                                           ; preds = %condeval12
  %i15 = load i32, i32* %i
  %array-index16 = getelementptr [10 x i32], [10 x i32]* %input_array1, i64 0, i32 %i15
